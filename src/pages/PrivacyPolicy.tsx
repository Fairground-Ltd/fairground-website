...
export default function PrivacyPolicy() {
  return (
    <div className={cn('font-fginterface min-h-screen bg-gradient-to-br text-white', COLORS.backgroundGradient)}>
      <div className="container mx-auto px-4 py-20 max-w-3xl">
        ...
        <div className={cn('text-lg leading-relaxed font-fginterface', COLORS.textSecondary)}>
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2 font-fgdisplay">1. Information We Collect</h3>
            <div className="mb-4">
              <h4 className="font-semibold mb-1 font-fgdisplay">1.1. Information You Provide</h4>
              <p>
            ...
            <div className="mb-4">
              <h4 className="font-semibold mb-1 font-fgdisplay">1.2. Automatically Collected Information</h4>
              <p>
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2 font-fgdisplay">2. How We Use Your Information</h3>
            <div className="mb-4">
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2 font-fgdisplay">3. Sharing Your Information</h3>
            <p>
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2 font-fgdisplay">4. Data Security</h3>
            <p>
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2 font-fgdisplay">5. Your Rights</h3>
            <p>
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2 font-fgdisplay">6. Changes to This Privacy Policy</h3>
            <p>
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2 font-fgdisplay">7. Contact Us</h3>
            <p>
