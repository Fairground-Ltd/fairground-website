    ...
    <div className={cn('min-h-screen bg-gradient-to-br text-white', COLORS.backgroundGradient)}>
      <div className="container mx-auto px-4 py-20 max-w-3xl">
        ...
        <div className={cn('text-lg leading-relaxed', COLORS.textSecondary)}>
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">1. Use of the Platform</h2>
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">2. Content and Intellectual Property</h2>
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">3. In-App Purchases and Ticket Sales</h2>
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">4. Prohibited Activities</h2>
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">5. Limitation of Liability</h2>
          <p className="mb-4">
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">6. Termination</h2>
          <p className="mb-4">
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">7. Governing Law</h2>
          <p className="mb-4">
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">8. Changes to Terms</h2>
          <p className="mb-4">
          ...
          <h2 className="mt-8 mb-2 text-2xl font-semibold">9. Contact Us</h2>
