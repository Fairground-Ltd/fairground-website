...
const TermsAndConditions = () => (
  <div className="policy-page">
    ...
    <p>
      <strong>1.2. Account Registration</strong><br/>
    ...
    <p>
      <strong>2.1. User-Generated Content</strong><br/>
    ...
    <p>
      <strong>2.2. Fairground Content</strong><br/>
    ...
    <h2>3. In-App Purchases and Ticket Sales</h2>
    <p>
      <strong>3.1. In-App Purchases</strong><br/>
    ...
    <p>
      <strong>3.2. Ticket Sales</strong><br/>
    ...
    <p>You agree not to engage in the following activities while using the Platform:</p>
    <ul>
